...
echo $Y.
"
____   ___  __  __ ____  __  __ ____
| __ ) / _ \|  \/  / ___||  \/  / ___|
|  _ \| | | | |\/| \___ \| |\/| \___ \
| |_) | |_| | |  | |___) | |  | |___) |
|____/ \___/|_|  |_|____/|_|  |_|____/";
echo $R."\n++++++++++++++++++++++++++++++++++++++";
echo $B."\nAuthor  : ALFIN KURNIAWAN             .$R.'+';
echo $B."\nGithub  : https://github.com/kangssh".$R.'+';
echo $B."\nTeam    : GRETONGER INDONESIA         ".$R.'+';
echo $B."\nVersion : 1.0                         ".$R.'+';
echo $B."\nDate    : 06-09-2018                  ".$R.'+';
echo $R."\n++++++++++++++++++++++++++++++++++++++".$G.$X."\n\n";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		echo "Send BM SMS To -> ".$G.$argv[1].$X."\n";	
...
while(1) {
foreach($argv[1] as $argv[2]):
echo "Send BOMSMS To -> ".$G.$argv[2].$X."\n";
